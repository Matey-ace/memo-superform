...
for (const id of ['ttsRoleNewBtn', 'ttsRoleEditBtn', 'ttsRoleActivateBtn', 'ttsRoleGptFile', 'ttsRoleAudioFile']) {
  assert(index.includes(id), `missing role package control ${id}`);
}
